...
class CoverPageAdapter(
    ...
    // Track active visualizer views for FFT data updates
    private val activeVisualizerViews = mutableSetOf<VisualizerView>()
                ...
                .into(object : CustomTarget<Bitmap>() {
                    override fun onResourceReady(bitmap: Bitmap, transition: Transition<in Bitmap>?) {
                        Palette.from(bitmap).generate { palette ->
                            ...
                            // Alle aktiven Visualizer aktualisieren
                            activeVisualizerViews.forEach { view ->
    ...
    override fun onFftDataAvailable(magnitudes: FloatArray) {
        activeVisualizerViews.forEach { it.setMagnitudes(magnitudes) }
    }
